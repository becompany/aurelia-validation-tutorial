define('resources/validation/simple-validation-renderer',["require", "exports"], function (require, exports) {
    "use strict";
    var SimpleValidationRenderer = (function () {
        ...
        SimpleValidationRenderer.prototype.render = function (instruction) {
            ...
            var _loop_1 = function(error, elements) {
                elements.forEach(function (target) { return target.parentElement.querySelector(".error").textContent = error.message; });
            };
            for (var _c = 0, _d = instruction.render; _c < _d.length; _c++) {
                var _e = _d[_c], error = _e.error, elements = _e.elements;
                _loop_1(error, elements);
            }
        };
...
define('app',["require", "exports", "aurelia-validation", "aurelia-dependency-injection", "./resources/validation/simple-validation-renderer"], function (require, exports, aurelia_validation_1, aurelia_dependency_injection_1, simple_validation_renderer_1) {
    "use strict";
    var App = (function () {
        function App(validationController) {
            ...
            this.country = "";
            this.validationController.addRenderer(new simple_validation_renderer_1.SimpleValidationRenderer());
        }
...
define('resources/elements/country-detail',["require", "exports", "aurelia-framework", "aurelia-validation"], function (require, exports, aurelia_framework_1, aurelia_validation_1) {
    "use strict";
    var CountryDetail = (function () {
        function CountryDetail() {
            this.validate = false;
            aurelia_validation_1.ValidationRules
                .ensure(function (c) { return c.name; })
                .displayName("My super fancy country")
                .required()
                .when(function (c) { return c.validate == true; })
                .on(this);
        }
        __decorate([
        ...
        ], CountryDetail.prototype, "validate", void 0);
...
define('resources/elements/person-detail',["require", "exports", "aurelia-framework", "aurelia-validation"], function (require, exports, aurelia_framework_1, aurelia_validation_1) {
    "use strict";
